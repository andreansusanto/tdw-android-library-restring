...
import tdw.library.restring.LocaleUtil
import tdw.library.restring.PluralKeyword
import tdw.library.restring.StringRepository
import java.util.*
...
class SharedPrefStringRepository(context: Context,
    ...
    private companion object {
        private const val STRINGS_SHARED_PREF_NAME = "tdw.library.restring.Restring_Strings"
        private const val TEXTS_SHARED_PREF_NAME = "tdw.library.restring.Restring_Texts"
        private const val LOCALES_SHARED_PREF_NAME = "tdw.library.restring.Restring_Locales"
        private const val QUANTITY_STRINGS_SHARED_PREF_NAME = "tdw.library.restring.Restring_Quantity_Strings"
        private const val STRING_ARRAYS_SHARED_PREF_NAME = "tdw.library.restring.Restring_String_Arrays"

        private const val LOCALES_SHARED_PREF_KEY = "tdw.library.restring.Restring_Locales_Key"
    }
}